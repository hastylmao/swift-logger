            ...
            <div className="space-y-4">
              ...
              {!foodImage ? (
                <button
                  ...
                  className="w-full aspect-video rounded-xl border-2 border-dashed border-slate-700 flex flex-col items-center justify-center gap-2 hover:border-green-500/50 transition-colors"
                >
                ...
                <>
                  <div>
                    <label className="text-slate-400 text-sm mb-1 block">
                      Describe what's in the photo (helps with accuracy)
                    </label>
                    <textarea
                      ...
                      placeholder="e.g., Bowl of rice with grilled chicken breast and steamed broccoli, about 300g rice, 150g chicken"
                      className="w-full bg-slate-800 text-white px-4 py-3 rounded-xl border border-slate-700 focus:border-green-500 focus:outline-none resize-none h-20"
                    />
                  </div>
